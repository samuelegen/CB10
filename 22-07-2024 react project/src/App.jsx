										...
										<tr key={product.id}>
											...
											<td className="whitespace-nowrap px-4 py-2">
												<Link
													...
													className="inline-block rounded bg-indigo-600 px-4 py-2 text-xs font-medium text-white hover:bg-indigo-700 m-2"
												>
													View
												</Link>
												<Link className="inline-block rounded bg-red-600 px-4 py-2 text-xs font-medium text-white">
													Delete
												</Link>
											</td>
										</tr>
